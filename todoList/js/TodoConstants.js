...
const TodoGUIId = {
    ...
    LIST_ITEM_DESCRIPTION_TEXTFIELD: "item_description_textfield",
    LIST_ITEM_ASSIGNED_TO_TEXTFIELD: "assigned_to_textfield",
    LIST_ITEM_DUE_DATE_DROPDOWN: "due_date_dropdown",
    LIST_ITEMS_COMPLETED_CHECKBOX: "completed_checkbox",

    MODAL_YES_NO_DIALOG: 'modal_yes_no_dialog',
    MODAL_YES_NO_DIALOG_SHOW: 'modal_yes_no_dialog_show',
    MODAL_YES_NO_DIALOG_HIDE: 'modal_yes_no_dialog_hide',
    MODAL_YES_NO_DIALOG_BACKGROUND_SHOW: 'modal_yes_no_dialog_background_show',
    MODAL_YES_NO_DIALOG_BACKGROUND_HIDE: 'modal_yes_no_dialog_background_hide',
    LIST_DELETE_LIST: 'list_delete_list',
    LIST_CANCEL_DELETE_LIST: 'list_cancel_delete_list',
    LIST_SUBMIT_LIST: 'list_submit_list',
    LIST_CANCEL_SUBMIT_LIST: 'list_cancel_submit_list'
};
...
const TodoGUIClass = {
    ...
    LIST_ITEM_MOVE_UP_FIRST: "list_item_move_up_first",
    LIST_ITEM_MOVE_DOWN: "list_item_move_down",
    LIST_ITEM_MOVE_DOWN_LAST: "list_item_move_down_last",
